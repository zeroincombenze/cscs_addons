...
openerp.web_gantt_chart = function (instance) {
...
instance.web.ViewManager.include({
   init:function(){
	   instance.web.views.add('gantt', 'instance.web_gantt_chart.GanttView')
       this._super.apply(this, arguments);
   } 
});

instance.web_gantt_chart.GanttView = instance.web.View.extend({
